        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">STEM Program</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Arts Program</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-400">
              ...
              <p>Email: info@eduprime-school.com</p>
            </address>
          </div>
        </div>
        
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {currentYear} EduPrime School. All rights reserved.</p>
